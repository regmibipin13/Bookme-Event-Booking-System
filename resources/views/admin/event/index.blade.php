                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'category'">{{ trans('admin.event.columns.category') }}</th>
                                        <th is='sortable' :column="'total_seats'">{{ trans('admin.event.columns.total_seats') }}</th>
                                        <th is='sortable' :column="'start_time'">{{ trans('admin.event.columns.start_time') }}</th>
                                        <th is='sortable' :column="'end_time'">{{ trans('admin.event.columns.end_time') }}</th>
                                        <th is='sortable' :column="'is_custom_seat'">{{ trans('admin.event.columns.is_custom_seat') }}</th>
                                ...
                                <tbody>
                                    ...
                                    <td>@{{ item.id }}</td>
                                        ...
                                        <td>
                                            <span v-if="item.is_custom_seat" class="badge-pill badge-success">
                                                yes
                                            </span>
                                            <span class="badge-pill badge-danger" v-else>no</span>
                                        </td>
